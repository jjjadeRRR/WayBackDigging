...
> **Проект полностьюс сделан внутри Google AI Studio.** > Код генерировался нейросетью, поэтому под капотом может твориться полная анархия, а архитектурные решения могут заставить плакать опытных Android-разработчиков.
> 
